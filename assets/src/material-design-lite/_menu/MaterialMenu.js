...
class MaterialMenu {
	...
	show(evt) {
		if (this.element_ && this.container_ && this.outline_) {
			...
			let height = this.element_.getBoundingClientRect().height;
			let width = this.element_.getBoundingClientRect().width;
			...
			let transitionDuration = this.Constant_.TRANSITION_DURATION_SECONDS *
